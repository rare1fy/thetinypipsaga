...
func _build_ui() -> void:
	...
	_tooltip_panel.visible = false
	_tooltip_panel.custom_minimum_size = Vector2(180, 80)
	...
	_tooltip_faces.add_theme_font_size_override("font_size", 10)
	...
	_tooltip_desc.custom_minimum_size = Vector2(160, 40)
	_tooltip_desc.add_theme_font_size_override("normal_font_size", 10)

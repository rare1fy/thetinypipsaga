...
("EL2", "元素", "风", "WIND", ""),
    ...
    et_rows = [
        ("ET01", "damage", "造成伤害（加法）对应 EffectType.BONUS_DAMAGE params.value"),
        ("ET02", "damage_mult", "伤害倍率（乘法）对应 EffectType.DAMAGE_MULT params.value"),
        ("ET03", "armor", "获得护甲 对应 EffectType.ARMOR params.value"),
        ("ET04", "heal", "恢复生命 对应 EffectType.HEAL params.value"),
        ("ET05", "pierce", "穿甲 对应 EffectType.PIERCE params.value"),
        ("ET06", "self_damage", "自残 对应 EffectType.SELF_DAMAGE params.value"),
        ("ET07", "status_to_enemy", "给敌人施加状态 对应 EffectType.APPLY_STATUS params.status/value/target"),
        ("ET08", "status_to_self", "给自身施加状态 对应 EffectType.APPLY_STATUS params.target=self"),
        ("ET09", "extra_dice", "衍生骰子 对应 EffectType.GRANT_SHADOW_DIE / CLONE_SELF"),
        ("ET10", "bonus_on_keep", "保留到下回合的加成 对应 EffectType.BONUS_ON_KEEP params.value"),
        ("ET11", "scale_flag", "缩放标记（条件触发类）对应 EffectType 的 condition 字段"),
        ("ET12", "special", "特殊逻辑 对应各专用 EffectType（EXECUTE/DETONATE/ESCALATE 等）"),
        ("ET20", "gold_bonus", "金币加成 对应 EffectType.GOLD_GAIN params.value"),
        ("ET21", "draw_bonus", "抽牌加成 对应 EffectType.MODIFY_DRAW_COUNT params.value"),
        ("ET22", "shop_discount", "商店折扣 对应 EffectType.SHOP_DISCOUNT params.value"),
        ("ET23", "free_rerolls", "免费重投 对应 EffectType.GRANT_REROLL params.count"),
        ("ET24", "extra_play", "额外出牌 对应 EffectType.GRANT_EXTRA_PLAY params.count"),
        ("ET25", "extra_reroll", "额外重投 对应 EffectType.GRANT_REROLL params.count"),
        ("ET26", "extra_draw", "额外抽牌 对应 EffectType.MODIFY_DRAW_COUNT params.value"),
    ]

...
static func _build_ch1_normals() -> void:
	_register("forest_ghoul", "食尸鬼", 1, 28, 10, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.WARRIOR, 20,
		[_phase(0, [_action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.ATTACK, 12, "撕咬"), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
	...
	_register("forest_spider", "剧毒蛛母", 1, 18, 6, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.RANGER, 20,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "剧毒", false), _action(EnemyAction.ActionType.ATTACK, 6), _action(EnemyAction.ActionType.ATTACK, 6)])],
	...
	_register("forest_banshee", "哀嚎女妖", 1, 16, 8, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.CASTER, 20,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 1, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 8), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
	...
	_register("forest_wolf_priest", "月光狼灵", 1, 20, 7, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 20,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "剧毒", false), _action(EnemyAction.ActionType.SKILL, 1, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 7)])],
	...
	_register("forest_poison_sprite", "毒雾林精", 1, 16, 5, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.RANGER, 22,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 3, "剧毒", false), _action(EnemyAction.ActionType.ATTACK, 5), _action(EnemyAction.ActionType.SKILL, 2, "剧毒", false)])],
	...
	_register("forest_wraith_cultist", "幽冥诅祝", 1, 18, 7, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.CASTER, 22,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 7), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
	...
	_register("forest_old_willow", "老槐祭司", 1, 22, 6, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 22,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "剧毒", false), _action(EnemyAction.ActionType.DEFEND, 6), _action(EnemyAction.ActionType.SKILL, 1, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 6)])],
...
static func _build_ch2_normals() -> void:
	...
	_register("ice_crystal_archer", "冰晶射手", 2, 20, 7, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.RANGER, 22,
		[_phase(0, [_action(EnemyAction.ActionType.ATTACK, 7), _action(EnemyAction.ActionType.ATTACK, 9, "冰棱射击"), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
	...
	_register("ice_coffin_wraith", "冰棺咒灵", 2, 20, 8, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.CASTER, 22,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 8), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
	...
	_register("ice_frost_elder", "霜祭冰尊", 2, 26, 6, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 22,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.DEFEND, 8), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 6)])],
	...
	_register("ice_holy_bishop", "圣冰牧首", 2, 30, 5, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 22,
		[_phase(0, [_action(EnemyAction.ActionType.DEFEND, 10), _action(EnemyAction.ActionType.SKILL, 2, "剧毒", false), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 5)])],
...
static func _build_ch3_normals() -> void:
	...
	_register("lava_shaman", "火焰萨满", 3, 22, 3, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 20,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "灼烧", false), _action(EnemyAction.ActionType.SKILL, 1, "护甲祝福", false), _action(EnemyAction.ActionType.ATTACK, 5)])],
	...
	_register("lava_bruiser", "熔岩重锤兵", 3, 38, 10, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.WARRIOR, 24,
		[_phase(0, [_action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 2, "灼烧", false), _action(EnemyAction.ActionType.ATTACK, 13, "熔铁重击")])],
	...
	_register("lava_sparkshooter", "火星箭手", 3, 22, 8, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.RANGER, 24,
		[_phase(0, [_action(EnemyAction.ActionType.ATTACK, 8), _action(EnemyAction.ActionType.SKILL, 2, "灼烧", false), _action(EnemyAction.ActionType.ATTACK, 11, "火星箭")])],
	...
	_register("lava_fire_mage", "焚心法师", 3, 22, 9, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.CASTER, 24,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 3, "灼烧", false), _action(EnemyAction.ActionType.ATTACK, 9), _action(EnemyAction.ActionType.SKILL, 1, "易伤", false)])],
	...
	_register("lava_ember_priest", "熔心祭司", 3, 28, 6, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 24,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "灼烧", false), _action(EnemyAction.ActionType.DEFEND, 8), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 6)])],
	...
	_register("lava_cinder_oracle", "余烬圣司", 3, 32, 5, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 24,
		[_phase(0, [_action(EnemyAction.ActionType.DEFEND, 10), _action(EnemyAction.ActionType.SKILL, 2, "灼烧", false), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 5)])],
...
static func _build_ch4_normals() -> void:
	...
	_register("shadow_crossbow", "邪能弩手", 4, 26, 10, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.RANGER, 26,
		[_phase(0, [_action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 12, "邪能穿透")])],
	...
	_register("shadow_sin_priest", "堕落司祭", 4, 28, 6, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 26,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "剧毒", false), _action(EnemyAction.ActionType.DEFEND, 8), _action(EnemyAction.ActionType.SKILL, 1, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 6)])],
	...
	_register("shadow_void_prophet", "渊影预言者", 4, 32, 5, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 26,
		[_phase(0, [_action(EnemyAction.ActionType.DEFEND, 10), _action(EnemyAction.ActionType.SKILL, 2, "剧毒", false), _action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 5)])],
...
static func _build_ch5_normals() -> void:
	...
	_register("eternal_priest", "泰坦祭司", 5, 24, 3, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.PRIEST, 20,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "护甲祝福", false), _action(EnemyAction.ActionType.SKILL, 1, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 6, "圣光惩击")])],
	...
	_register("eternal_skyknight", "穹苍骑兵", 5, 26, 9, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.RANGER, 28,
		[_phase(0, [_action(EnemyAction.ActionType.ATTACK, 9), _action(EnemyAction.ActionType.ATTACK, 12, "俯冲射"), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
	...
	_register("eternal_chronomancer", "时砂法师", 5, 24, 9, EnemyCategory.NORMAL, GameTypes.EnemyCombatType.CASTER, 28,
		[_phase(0, [_action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 9), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
...
static func _build_elites() -> void:
	...
	_register("elite_phantom_hunter", "魅影猎手", 1, 90, 10, EnemyCategory.ELITE, GameTypes.EnemyCombatType.RANGER, 50,
		[_phase(0.35, [_action(EnemyAction.ActionType.ATTACK, 16, "幽影穿心"), _action(EnemyAction.ActionType.SKILL, 2, "剧毒", false)]),
		 _phase(0, [_action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 1, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 8)])],
	...
	_register("elite_frost_archon", "霜誓执政", 2, 105, 9, EnemyCategory.ELITE, GameTypes.EnemyCombatType.PRIEST, 50,
		[_phase(0.35, [_action(EnemyAction.ActionType.SKILL, 3, "剧毒", false), _action(EnemyAction.ActionType.SKILL, 2, "虚弱", false), _action(EnemyAction.ActionType.DEFEND, 16)]),
		 _phase(0, [_action(EnemyAction.ActionType.ATTACK, 9), _action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.DEFEND, 12)])],
	...
	_register("elite_flame_oracle", "烈焰谕者", 3, 95, 10, EnemyCategory.ELITE, GameTypes.EnemyCombatType.PRIEST, 50,
		[_phase(0.35, [_action(EnemyAction.ActionType.SKILL, 3, "灼烧", false), _action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.DEFEND, 14)]),
		 _phase(0, [_action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 2, "灼烧", false), _action(EnemyAction.ActionType.DEFEND, 10)])],
	...
	_register("elite_nightfang_stalker", "夜牙潜影", 4, 95, 12, EnemyCategory.ELITE, GameTypes.EnemyCombatType.RANGER, 50,
		[_phase(0.35, [_action(EnemyAction.ActionType.ATTACK, 18, "夜牙穿刺"), _action(EnemyAction.ActionType.SKILL, 2, "剧毒", false)]),
		 _phase(0, [_action(EnemyAction.ActionType.ATTACK, 12), _action(EnemyAction.ActionType.SKILL, 1, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 10)])],
	...
	_register("elite_celestial_champion", "天裁斗神", 5, 115, 11, EnemyCategory.ELITE, GameTypes.EnemyCombatType.WARRIOR, 50,
		[_phase(0.35, [_action(EnemyAction.ActionType.ATTACK, 18, "天裁圣击"), _action(EnemyAction.ActionType.DEFEND, 16), _action(EnemyAction.ActionType.SKILL, 2, "易伤", false)]),
...
static func _build_bosses() -> void:
	...
	_register_boss("boss_root_colossus", "根须巨像", 1, 135, 11, BossRank.MID, GameTypes.EnemyCombatType.GUARDIAN, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.ATTACK, 14, "根须重拳"), _action(EnemyAction.ActionType.DEFEND, 24), _action(EnemyAction.ActionType.ATTACK, 12), _action(EnemyAction.ActionType.SKILL, 2, "剧毒", false)]),
		 _phase(0, [_action(EnemyAction.ActionType.DEFEND, 14), _action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
		_boss_quotes(
	...
	_register_boss("boss_coven_matriarch", "魇森巫母", 1, 115, 9, BossRank.MID, GameTypes.EnemyCombatType.CASTER, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 12, "诅咒爆发"), _action(EnemyAction.ActionType.SKILL, 3, "剧毒", false), _action(EnemyAction.ActionType.DEFEND, 12)]),
		 _phase(0, [_action(EnemyAction.ActionType.SKILL, 1, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 9), _action(EnemyAction.ActionType.SKILL, 2, "剧毒", false)])],
		_boss_quotes(
	...
	_register_boss("boss_frost_hammer", "冰锤领主", 2, 140, 12, BossRank.MID, GameTypes.EnemyCombatType.WARRIOR, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.ATTACK, 16, "冰锤粉碎"), _action(EnemyAction.ActionType.SKILL, 2, "冻结", false), _action(EnemyAction.ActionType.ATTACK, 13), _action(EnemyAction.ActionType.DEFEND, 18)]),
		 _phase(0, [_action(EnemyAction.ActionType.DEFEND, 14), _action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false)])],
		_boss_quotes(
	...
	_register_boss("boss_winter_huntress", "寒霜女猎", 2, 120, 10, BossRank.MID, GameTypes.EnemyCombatType.RANGER, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.ATTACK, 11, "冰棱连发"), _action(EnemyAction.ActionType.SKILL, 2, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 13, "致命一箭"), _action(EnemyAction.ActionType.DEFEND, 10)]),
		 _phase(0, [_action(EnemyAction.ActionType.ATTACK, 9), _action(EnemyAction.ActionType.SKILL, 1, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 10)])],
		_boss_quotes(
			["风雪里的脚印——是我给你的最后警告。"],
			["雪狼群——上。我要先看清你的步法。"],
			["箭……偏了……", "今夜的风……怪我……"],
	...
	_register_boss("boss_magma_tyrant", "岩浆暴君", 3, 145, 13, BossRank.MID, GameTypes.EnemyCombatType.GUARDIAN, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.ATTACK, 16, "熔岩巨锤"), _action(EnemyAction.ActionType.DEFEND, 26), _action(EnemyAction.ActionType.SKILL, 3, "灼烧", false), _action(EnemyAction.ActionType.ATTACK, 12)]),
		 _phase(0, [_action(EnemyAction.ActionType.DEFEND, 18), _action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 2, "虚弱", false)])],
		_boss_quotes(
	...
	_register_boss("boss_soulforge_warlock", "魂炉术士", 3, 120, 10, BossRank.MID, GameTypes.EnemyCombatType.CASTER, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.SKILL, 1, "诅咒注入", false), _action(EnemyAction.ActionType.ATTACK, 12, "魂炉熔诅"), _action(EnemyAction.ActionType.SKILL, 3, "灼烧", false), _action(EnemyAction.ActionType.DEFEND, 12)]),
		 _phase(0, [_action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.SKILL, 2, "灼烧", false)])],
		_boss_quotes(
	...
	_register_boss("boss_void_inquisitor", "虚空审判官", 4, 135, 11, BossRank.MID, GameTypes.EnemyCombatType.PRIEST, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 13, "虚空审决"), _action(EnemyAction.ActionType.SKILL, 3, "剧毒", false), _action(EnemyAction.ActionType.DEFEND, 18)]),
		 _phase(0, [_action(EnemyAction.ActionType.SKILL, 1, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 2, "剧毒", false)])],
		_boss_quotes(
			["虚空议会——已对你作出终审判决。"],
	...
	_register_boss("boss_chaos_tactician", "混沌谋略家", 4, 125, 10, BossRank.MID, GameTypes.EnemyCombatType.CASTER, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.ATTACK, 12, "混乱之触"), _action(EnemyAction.ActionType.SKILL, 1, "诅咒注入", false), _action(EnemyAction.ActionType.SKILL, 2, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 10)]),
		 _phase(0, [_action(EnemyAction.ActionType.ATTACK, 9), _action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.DEFEND, 12)])],
		_boss_quotes(
	...
	_register_boss("boss_chrono_archon", "时流执政", 5, 145, 12, BossRank.MID, GameTypes.EnemyCombatType.CASTER, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.ATTACK, 14, "时流撕裂"), _action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.DEFEND, 18), _action(EnemyAction.ActionType.ATTACK, 11)]),
		 _phase(0, [_action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.SKILL, 2, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 12)])],
		_boss_quotes(
	...
	_register_boss("boss_celestial_archon", "圣辉执政", 5, 135, 11, BossRank.MID, GameTypes.EnemyCombatType.PRIEST, 55,
		[_phase(0.5, [_action(EnemyAction.ActionType.SKILL, 2, "易伤", false), _action(EnemyAction.ActionType.ATTACK, 13, "圣辉审判"), _action(EnemyAction.ActionType.DEFEND, 20), _action(EnemyAction.ActionType.SKILL, 3, "剧毒", false)]),
		 _phase(0, [_action(EnemyAction.ActionType.SKILL, 1, "虚弱", false), _action(EnemyAction.ActionType.ATTACK, 10), _action(EnemyAction.ActionType.DEFEND, 14)])],
		_boss_quotes(
